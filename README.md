...
**Welcome to use this blog theme, but please keep the theme author info at footer.** Theme designed by [entenity](https://github.com/gaohaoyang).
...
# comments
# two ways to comment, only choose one, and use your own short name
duoshuo_shortname: #entenityblog
